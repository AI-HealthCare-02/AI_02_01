...
class HealthRecordCreateRequest(BaseModel):
    ...
    height: Annotated[float, Field(gt=0, le=300, description="키 (cm)")]
    weight: Annotated[float, Field(gt=0, le=500, description="몸무게 (kg)")]
...
class HealthRecordUpdateRequest(BaseModel):
    ...
    height: Annotated[float | None, Field(None, gt=0, le=300, description="키 (cm)")]
    weight: Annotated[float | None, Field(None, gt=0, le=500, description="몸무게 (kg)")]
